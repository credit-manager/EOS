...
class ConsoleEmailProvider(EmailProvider):
    ...
    def send(self, to_email, subject, html_body, text_body=None, from_email=None, from_name=None) -> dict:
        ...
        entry = {
            "to": to_email, "from": f"{from_name} <{from_email}>", "subject": subject,
        ...
        logger.info(f"[EMAIL-CONSOLE] To: {to_email} | Subject: {subject} | ID: {msg_id}")
...
class SMTPEmailProvider(EmailProvider):
    ...
    def __init__(self, host=None, port=None, username=None, password=None, use_tls=True, from_email=None, from_name=None):
...
class EmailTemplateEngine:
    ...
    def welcome_email(first_name="User", company_name="Your Company") -> dict:
        return {
            ...
            "html": f"<div style='font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:20px'><h2>Account Activated!</h2><p>Hello {first_name}, your account for <strong>{company_name}</strong> is now active.</p></div>",
