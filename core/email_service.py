...
class EmailService:
    def __init__(self):
        ...
        self.from_email = os.getenv("FROM_EMAIL", "noreply@2to-erp.com")
        self.from_name = os.getenv("FROM_NAME", "2TO Platform")
    ...
    def send_invitation(self, to_email, tenant_name, role, invited_by):
        ...
        <div style="font-family: Arial; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #1890ff;">You're Invited to 2TO Platform</h2>
        ...
        """
        return self.send(to_email, f"Invitation to {tenant_name} — 2TO Platform", html)
    ...
    def send_password_reset(self, to_email, reset_token, user_name):
        ...
        """
        return self.send(to_email, "Password Reset — 2TO Platform", html)
