...
async def list_policies(is_active: bool = None, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def list_checks(policy_id: str = None, status: str = None, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def list_violations(status: str = None, severity: str = None, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def list_audit_log(action: str = None, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def list_frameworks(framework_type: str = None, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
