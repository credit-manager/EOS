...
async def list_companies(user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def create_company(body: dict, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def get_company(company_id: str, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def create_branch(company_id: str, body: dict, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
    if not body.get("code") or not body.get("name_en"):
        raise HTTPException(400, detail={"status": "error", "error": {"code": "MISSING", "message": "code and name_en required"}})
...
async def create_department(company_id: str, body: dict, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
    if not body.get("code") or not body.get("name_en"):
        raise HTTPException(400, detail={"status": "error", "error": {"code": "MISSING", "message": "code and name_en required"}})
...
async def create_fiscal_year(company_id: str, body: dict, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def list_currencies(user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
...
async def create_cost_center(company_id: str, body: dict, user: dict = Depends(get_current_user), db: Session = Depends(get_db)):
    if not body.get("code") or not body.get("name_en"):
        raise HTTPException(400, detail={"status": "error", "error": {"code": "MISSING", "message": "code and name_en required"}})
