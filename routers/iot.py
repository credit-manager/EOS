...
async def list_devices(device_type: str | None = None, status: str | None = None, user: dict | None=None, db: Session = Depends(get_db)):
...
async def create_device(body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def get_device(device_id: str, user: dict | None=None, db: Session = Depends(get_db)):
...
async def update_device(device_id: str, body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def heartbeat(device_id: str, user: dict | None=None, db: Session = Depends(get_db)):
...
async def list_telemetry(device_id: str | None = None, metric_name: str | None = None, limit: int = 100,
...
async def record_telemetry(body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def list_alerts(device_id: str | None = None, is_acknowledged: bool | None = None, severity: str | None = None,
                     user: dict | None=None, db: Session = Depends(get_db)):
...
async def create_alert(body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def acknowledge_alert(alert_id: str, body: dict | None = None, user: dict | None=None, db: Session = Depends(get_db)):
    if body is None:
        body = {}
...
async def list_rules(device_type: str | None = None, is_active: bool | None = None, user: dict | None=None, db: Session = Depends(get_db)):
...
async def update_rule(rule_id: str, body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def list_firmware(device_type: str | None = None, user: dict | None=None, db: Session = Depends(get_db)):
...
async def create_firmware(body: dict, user: dict | None=None, db: Session = Depends(get_db)):
