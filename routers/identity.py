...
async def list_providers(is_active: bool | None = None, user: dict | None=None, db: Session = Depends(get_db)):
...
async def create_provider(body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def update_provider(provider_id: str, body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def list_sessions(user_id: str | None = None, user: dict | None=None, db: Session = Depends(get_db)):
...
async def create_session(body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def list_mfa(user_id: str | None = None, user: dict | None=None, db: Session = Depends(get_db)):
...
async def setup_mfa(body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def enable_mfa(mfa_id: str, user: dict | None=None, db: Session = Depends(get_db)):
...
async def disable_mfa(mfa_id: str, user: dict | None=None, db: Session = Depends(get_db)):
...
async def list_role_mappings(provider_id: str | None = None, user: dict | None=None, db: Session = Depends(get_db)):
...
async def create_role_mapping(body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def delete_role_mapping(mapping_id: str, user: dict | None=None, db: Session = Depends(get_db)):
...
async def list_api_keys(is_active: bool | None = None, user: dict | None=None, db: Session = Depends(get_db)):
...
async def create_api_key(body: dict, user: dict | None=None, db: Session = Depends(get_db)):
...
async def revoke_api_key(key_id: str, user: dict | None=None, db: Session = Depends(get_db)):
