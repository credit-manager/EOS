...
def deploy_definition(
    ...
    *,
    ...
    # Contract-compatible audit shape: resource_type carries the entity code
    # (as it did before the B01 refactor) so downstream consumers and the
    # published audit-query contract keep working; entity UUID stays in
    # resource_id, code/version in details.
    audit_record(
        db,
        tenant_id=tenant_id,
        actor_id=actor_id,
