...
__all__ = ["Rule", "RuleExecution", "DelayedAction"]
...
class DelayedAction(Base):
    """Delayed rule actions that will be executed after a specified delay."""
    ...
    status: Mapped[str] = mapped_column(String(20), nullable=False, default="pending")  # pending, executing, completed, failed
