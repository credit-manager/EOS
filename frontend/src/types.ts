...
export type Permissions = { admin:Array<'create'|'read'|'update'|'delete'>; member:Array<'create'|'read'|'update'|'delete'> };
...
export type Session = { access_token:string; user_id:string; tenant_id:string; role:string; expires_in:number; expires_at?:number; refresh_token?:string; refresh_expires_in?:number };
