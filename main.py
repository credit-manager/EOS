...
from routers import dynamic_crud, relationships, entity_management, events_webhooks
from routers import security_admin, auto_ui, notifications, dashboards, workflows, data_jobs
from routers import webhook_management, validation, erp_foundation, accounting, finance
from routers import procurement, inventory, sales, sales_api, inventory_api, accounting_api
from routers import projects_api, hr_api, control_plane, construction_api, industry_framework
from routers import trading_api, retail_api, restaurant_api, manufacturing_api, services_api
from routers import notify_api, approve_api, docs_api, analytics_api, custom_api
from routers import hr, projects, fixed_assets, documents, audit, localization, esignature
from routers import api_quotas, reports, ai_features, system, production_ops, validation_ops
from routers import saas_cp, tenant_lifecycle, billing, edge_region, analytics, compliance
from routers import identity, iot, blockchain, platform_maturity, onboarding, ai_composer
from routers import builder, marketplace, billing_flow, portal, saas_journey
from routers import auth as auth_router, locale_router, analytics_router, whitelabel, ws_router
from routers import two_factor_api, payment_api, currency_api, reconciliation_api
from routers import portal_customer_api, reporting_api
...
# Metrics are operationally sensitive and must not be anonymously exposed in production.
...
# React frontend, when a production build exists.
