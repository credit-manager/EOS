...
from routers import (
    accounting, accounting_api, ai_composer, ai_features, analytics, analytics_api,
    analytics_router, api_quotas, approve_api, audit, auto_ui, billing, billing_flow,
    blockchain, builder, compliance, construction_api, control_plane, currency_api,
    custom_api, dashboards, data_jobs, docs_api, documents, dynamic_crud, edge_region,
    entity_management, erp_foundation, esignature, events_webhooks, finance,
    fixed_assets, hr, hr_api, identity, industry_framework, inventory, inventory_api,
    iot, locale_router, localization, manufacturing_api, marketplace, notifications,
    notify_api, onboarding, payment_api, platform_maturity, portal,
    portal_customer_api, procurement, production_ops, projects, projects_api,
    reconciliation_api, relationships, reporting_api, reports, restaurant_api,
    retail_api, saas_cp, saas_journey, sales, security_admin, services_api, system,
    tenant_lifecycle, trading_api, two_factor_api, validation, validation_ops,
    webhook_management, whitelabel, workflows, ws_router,
)
...
# sales_api is intentionally excluded: its legacy global CRM tables bypass the
# tenant-scoped SalesEngine contract used by the production API.
for _router in [
    ...
    inventory_api, accounting_api, projects_api, hr_api, control_plane,
